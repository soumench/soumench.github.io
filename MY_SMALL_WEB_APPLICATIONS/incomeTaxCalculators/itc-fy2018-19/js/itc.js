...
function update(){
    ...
    tobepaid.innerHTML=tbp<=0 ? `<br>nil, Your Refund: ${(tbp*-1)} ( আর কোনো আয়কর দিতে হবে না, আপনার রিফান্ড হবে ${(tbp*-1)} টাকা )` : `<br>Tax to be paid: Rs.${tbp} ( আপনাকে আরও ${tbp} টাকা আয়কর দিতে হবে )`
