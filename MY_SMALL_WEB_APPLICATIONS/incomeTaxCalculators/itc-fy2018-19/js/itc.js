...
function update(){    
    ...
    tobepaid.innerHTML=tbp<=0 ? `nil, ( Your Refund: Rs. ${Math.abs(tbp)} approx )<br> ( আর কোনো আয়কর দিতে হবে না, আপনার রিফান্ড হবে প্রায় ${Math.abs(tbp)} টাকা )` : `Tax to be paid: Rs.${tbp}<br> ( আপনাকে আরও ${tbp} টাকা আয়কর দিতে হবে )`
