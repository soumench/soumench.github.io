const qa = [ 
            ...
            8, "A man, getting into the compartment, stammered an apology. <br> ( Split into two simple sentences.)", "A man was getting into an apartment.<br> He stammered an apology. <br>( >>>> important <<<<)",
    
    		9, "This is not a correct approach. <br> (to Affirmative Sentence)","This is an incorrect approach.  <br> ( >>> important <<<<)",
    
			10,"A soldier, very young, lies open-mouthed.<br> (Rewrite as a complex sentence.)", "A soldier who is very young, lies open-mouthed.",
    
            11,"She was silent. ( to Negative Sentence.)","She was not speaking. <br> (>>> important <<<)",
            ...
            16, "The train gathered speed and the wheels took up their song. <br> (Turn into a Simple Sentence.)", "................... <br> ( >>>  important   <<<<< )",
            ...
            19, "Name the three characters of the play 'The Proposal'."," no hint <br> ( >>> important <<<)",
    
            20, "Whom did Lomov inherit the meadows from? ", " no hint <br>  (>>> important <<<)",
    
            21, "What will make the beauty of the poet's friend eternal?", " no hint  ( >>> important   <<< )",
    
            22, "Who would receive the girl at Saharanpur station?", " no hint  <br>  ( >>> important  <<<)",
            ...
            26, "How is the soldier lying in the sunlight? ", "no hint <br> ( >>> important  <<<< )",
            ...
            32, "Kalam's father would take him to the Mosque for ..", "evening prayers  <br>  ( >>> important  <<<)",
    
            33, "Lomov comes to Chubukov's house ....", " to propose his daughter <br>  ( >>> important <<<)",
    
            34, "'Oh how lucky you are' - Who is the speaker here?<br> Who is ‘you’ referred to here?<br> Why is the speaker spoken to considered lucky?", " no hint  <br> (>>> important <<<)",
    
            35, "'I have come to you to trouble you with a request' - Who is 'I' and 'you' referred to in the sentence?", "no hint <br> ( >>> important <<< )",
