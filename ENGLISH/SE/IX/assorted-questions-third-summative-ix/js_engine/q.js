...
*/
heading.innerHTML="Assorted Sample Questions <br>Class-IX";
var bank = [
    "Where did the shipwrecked sailor sleep at night?~no hint."
    
    , "Who was Robinson Crusoe?  ~ no hint"
    
    , "What happened to the rest of the Crusoe's ship’s company? ~ no hint"
    
    , "What were the things that Robinson collected from the wreck of his ship?~no hint"
    
    ,"What did the wind do to the second ship?~no hint"
    
    ,"Which ships came back happily or unhappily?~no hint"
    
    ,"Write the describing words that the poet used to describe the different seas.~no hint"
    
    ,"Man is mortal.<br>(to Negative Sentence)~No man is immortal."
    
    ,"Nikola Tesla was a great inventor.<br>(to Interrogative sentence)~Was not Nikola Tesla a great inventor?"
    
    ,"I lost my mobile but I have found it. (Change into a complex sentence.)~ no hint"
    ...
    ,"He said to me, “I have done it.” (Change the mode of narration.)~ no hint"
    
    ,"You have been ill for three days. Write a letter to the Headmaster of your school seeking leave of absence for those days.~ no hint"
